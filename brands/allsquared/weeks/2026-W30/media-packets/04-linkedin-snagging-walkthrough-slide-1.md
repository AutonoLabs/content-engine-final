# Packet 04 — linkedin — snagging-walkthrough (carousel slide 1/3)

> **Paste the prompt block into Higgsfield image model: `nano-banana-pro`**
> **Settings: 4:5, 2k resolution**
> **Your job: paste → download → rename to `2026-W30-04-slide-1.png` → drop in `brands/<brand>/inbox/`**
...
```
Photoreal still image. Subject: A tradesperson at the entrance of a finished kitchen, notebook open, torch in hand, looking at the room with a professional eye. completed UK kitchen refit, late morning. late morning natural daylight lighting. Editorial composition, clean negative space, portrait frame (LinkedIn carousel). lifestyle, candid, UK tradesperson. UK architectural details. Visual style must feel cohesive across all slides.
```
