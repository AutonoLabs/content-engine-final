# Packet 04 — linkedin — snagging-walkthrough (carousel slide 3/3)

> **Paste the prompt block into Higgsfield image model: `nano-banana-pro`**
> **Settings: 4:5, 2k resolution**
> **Your job: paste → download → rename to `2026-W30-04-slide-3.png` → drop in `brands/<brand>/inbox/`**
...
```
Photoreal still image. Subject: Tradie signing a completion document on a clean surface, kitchen visible in soft focus in the background, sunlight. completed UK kitchen refit, late morning. late morning natural daylight lighting. Editorial composition, clean negative space, portrait frame (LinkedIn carousel). lifestyle, candid, UK tradesperson. UK architectural details. Visual style must feel cohesive across all slides.
```
